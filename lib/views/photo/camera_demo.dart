...
import 'package:flutter_basics/views/photo/photo_grid_view.dart';
import 'package:flutter_basics/views/photo/photo_slider_view.dart';
  ...
  Widget _cameraTogglesRowWidget() {
    if (widget.cameras.isEmpty) {
      ...
      return Switch(
        ...
        value: isBackCamera,
        onChanged: (value) => _onToggleCamera(value),
      );
    }
  }
